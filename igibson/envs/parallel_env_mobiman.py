...
if __name__ == "__main__":
    ...
    print("[parallel_env_mobiman::__main__] START")
    
    logging.basicConfig(level=logging.INFO)
    config_filename = os.path.join(os.path.dirname(igibson.__file__), "..", "tests", "test.yaml")

    print("[parallel_env_mobiman::__main__] config_filename: " + str(config_filename))

    def load_env():
        return iGibsonEnv(config_file=config_filename, mode="headless")

    print("[parallel_env_mobiman::__main__] BEFORE ParallelNavEnv")

    parallel_env = ParallelNavEnv([load_env] * 2, blocking=False)

    from time import time

    print("[parallel_env_mobiman::__main__] BEFORE LOOP")
    ...
    print("[parallel_env_mobiman::__main__] END")
