...
class LunarLander(gym.Env, EzPickle):
    ...
    * The angular velocity is in units of 0.4 radians per second. In order to convert to radians per second, the value needs to be multiplied by a factor of 2.5.
    ...
    def __init__(
        ...
        print("[lunar_lander_custom::LunarLander::__init__] START")

        print("[lunar_lander_custom::LunarLander::__init__] eid: " + str(eid))

        self.eid = eid
        self.total_step_num = 0
        self.step_num = 0

        print("[lunar_lander_custom::LunarLander::__init__] self.eid: " + str(self.eid))

        #print("[lunar_lander_custom::LunarLander::__init__] DEBUG_INF")
        #while 1:
        #    continue
    ...
    def reset(
        ...
        *,
        ...
        #print("[lunar_lander_custom::LunarLander::reset] START")
        #print("[lunar_lander_custom::LunarLander::reset] seed: " + str(seed))
        ...
        print("[lunar_lander_custom::LunarLander::reset] END")
    ...
    def step(self, action):
        ...
        print("[lunar_lander_custom::LunarLander::step] START")
        print("[lunar_lander_custom::LunarLander::__init__] total_step_num: " + str(self.total_step_num))
        print("[lunar_lander_custom::LunarLander::__init__] step_num: " + str(self.step_num))

        if self.eid == 1:
            print("-------------------------------")
            print("[lunar_lander_custom::LunarLander::__init__] eid: " + str(self.eid))
            print("-------------------------------")
            sleep(2)
